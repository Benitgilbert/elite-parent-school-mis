    ...
    <div>
      ...
      <List>
        <ListItem disablePadding>
          <ListItemButton component={Link} href="/director">
            <ListItemText primary="Overview" />
          </ListItemButton>
        </ListItem>
        <ListItem disablePadding>
          <ListItemButton component={Link} href="/director/students">
            <ListItemText primary="Students" />
          </ListItemButton>
        </ListItem>
        <ListItem disablePadding>
          <ListItemButton component={Link} href="/director/teachers">
            <ListItemText primary="Teachers" />
          </ListItemButton>
        </ListItem>
        <ListItem disablePadding>
          <ListItemButton component={Link} href="/director/report-cards">
            <ListItemText primary="Report Cards" />
          </ListItemButton>
        </ListItem>
        <ListItem disablePadding>
          <ListItemButton component={Link} href="/director/approvals">
            <ListItemText primary="Approvals" />
          </ListItemButton>
        </ListItem>
        <ListItem disablePadding>
          <ListItemButton component={Link} href="/director/analytics">
            <ListItemText primary="Analytics" />
          </ListItemButton>
        </ListItem>
        <ListItem disablePadding>
          <ListItemButton component={Link} href="/director/settings">
    ...
    <Box sx={{ display: "flex" }}>
      ...
      <AppBar position="fixed" sx={{ zIndex: (t) => t.zIndex.drawer + 1 }}>
        <Toolbar>
          ...
          <Typography variant="h6" noWrap>Elite Parent School • Director</Typography>
          <Box sx={{ flexGrow: 1 }} />
