    ...
    <div>
      ...
      <List>
        <ListItem disablePadding>
          <ListItemButton component={Link} href="/patron">
            <ListItemText primary="Overview" />
          </ListItemButton>
        </ListItem>
        <ListItem disablePadding>
          <ListItemButton component={Link} href="/patron/cases">
            <ListItemText primary="Cases" />
          </ListItemButton>
        </ListItem>
        <ListItem disablePadding>
          <ListItemButton component={Link} href="/patron/reports">
            <ListItemText primary="Reports" />
          </ListItemButton>
        </ListItem>
        <ListItem disablePadding>
          <ListItemButton component={Link} href="/patron/settings">
    ...
    <Box sx={{ display: "flex" }}>
      ...
      <AppBar position="fixed" sx={{ zIndex: (t) => t.zIndex.drawer + 1 }}>
        <Toolbar>
          ...
          <Typography variant="h6" noWrap>Elite Parent School • Patron</Typography>
          <Box sx={{ flexGrow: 1 }} />
