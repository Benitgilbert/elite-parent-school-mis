...
export default function PatronOverviewPage() {
  ...
  function openStudentSummary() {
    if (!studentId) return;
    window.open(`/patron/reports?student_id=${encodeURIComponent(studentId)}`, "_self");
  }

  return (
    <Container maxWidth="lg" sx={{ py: 3 }}>
      <Typography variant="h5" sx={{ mb: 2 }}>Patron • Overview</Typography>
      ...
      <Paper variant="outlined" sx={{ p: 2, mb: 2 }}>
        ...
        <Stack direction={{ xs: "column", sm: "row" }} spacing={1}>
          <Button component={Link as any} href="/patron/cases" variant="contained">Cases</Button>
          <Button component={Link as any} href="/patron/reports" variant="outlined">Reports</Button>
          <Button component={Link as any} href="/patron/settings" variant="outlined">Settings</Button>
        </Stack>
      </Paper>
