...
export default function MatronLayout({ children }: { children: React.ReactNode }) {
  ...
  const drawer = (
    <div>
      <Toolbar>
        <Typography variant="h6">Matron</Typography>
      </Toolbar>
      <Divider />
      <List>
        <ListItem disablePadding>
          <ListItemButton component={Link} href="/matron">
            <ListItemText primary="Overview" />
          </ListItemButton>
        </ListItem>
        <ListItem disablePadding>
          <ListItemButton component={Link} href="/matron/cases">
            <ListItemText primary="Cases" />
          </ListItemButton>
        </ListItem>
        <ListItem disablePadding>
          <ListItemButton component={Link} href="/matron/reports">
            <ListItemText primary="Reports" />
          </ListItemButton>
        </ListItem>
        <ListItem disablePadding>
          <ListItemButton component={Link} href="/matron/settings">
    ...
    <Box sx={{ display: "flex" }}>
      ...
      <AppBar position="fixed" sx={{ zIndex: (t) => t.zIndex.drawer + 1 }}>
        <Toolbar>
          ...
          <Typography variant="h6" noWrap>Elite Parent School • Matron</Typography>
          <Box sx={{ flexGrow: 1 }} />
