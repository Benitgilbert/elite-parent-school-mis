  ...
  const drawer = (
    <div>
      ...
      <List>
        ...
        <ListItem disablePadding>
          <ListItemButton component={Link} href="/student/report-cards">
            <ListItemText primary="Report Cards" />
          </ListItemButton>
        </ListItem>
        <ListItem disablePadding>
          <ListItemButton component={Link} href="/student/grades">
        ...
        <ListItem disablePadding>
          <ListItemButton component={Link} href="/student/attendance">
            <ListItemText primary="Attendance" />
          </ListItemButton>
        </ListItem>
        <ListItem disablePadding>
          <ListItemButton component={Link} href="/student/timetable">
            <ListItemText primary="Timetable" />
          </ListItemButton>
        </ListItem>
        <ListItem disablePadding>
          <ListItemButton component={Link} href="/student/fees">
            <ListItemText primary="School Fees" />
          </ListItemButton>
        </ListItem>
      </List>
    </div>
    ...
    <Box sx={{ display: "flex" }}>
      ...
      <AppBar position="fixed" sx={{ zIndex: (t) => t.zIndex.drawer + 1 }}>
        <Toolbar>
          ...
          <Typography variant="h6" noWrap>Elite Parent School • Student</Typography>
          <Box sx={{ flexGrow: 1 }} />
