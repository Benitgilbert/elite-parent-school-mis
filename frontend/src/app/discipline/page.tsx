...
export default function DisciplineOverviewPage() {
  ...
  function openStudentSummary() {
    if (!studentId) return;
    window.open(`/discipline/reports?student_id=${encodeURIComponent(studentId)}`, "_self");
  }

  return (
    <Container maxWidth="lg" sx={{ py: 3 }}>
      <Typography variant="h5" sx={{ mb: 2 }}>Discipline • Overview</Typography>
      ...
      <Paper variant="outlined" sx={{ p: 2, mb: 2 }}>
        ...
        <Stack direction={{ xs: "column", sm: "row" }} spacing={1}>
          <Button component={Link as any} href="/discipline/cases" variant="contained">Cases</Button>
          <Button component={Link as any} href="/discipline/reports" variant="outlined">Reports</Button>
          <Button component={Link as any} href="/discipline/settings" variant="outlined">Settings</Button>
        </Stack>
      </Paper>
