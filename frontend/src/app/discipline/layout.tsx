    ...
    <div>
      ...
      <List>
        <ListItem disablePadding>
          <ListItemButton component={Link} href="/discipline">
            <ListItemText primary="Overview" />
          </ListItemButton>
        </ListItem>
        <ListItem disablePadding>
          <ListItemButton component={Link} href="/discipline/cases">
            <ListItemText primary="Cases" />
          </ListItemButton>
        </ListItem>
        <ListItem disablePadding>
          <ListItemButton component={Link} href="/discipline/reports">
            <ListItemText primary="Reports" />
          </ListItemButton>
        </ListItem>
        <ListItem disablePadding>
          <ListItemButton component={Link} href="/discipline/settings">
    ...
    <Box sx={{ display: "flex" }}>
      ...
      <AppBar position="fixed" sx={{ zIndex: (t) => t.zIndex.drawer + 1 }}>
        <Toolbar>
          ...
          <Typography variant="h6" noWrap>Elite Parent School • Discipline</Typography>
          <Box sx={{ flexGrow: 1 }} />
