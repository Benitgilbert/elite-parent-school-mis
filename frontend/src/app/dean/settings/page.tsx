...
import { Grid, Container, Typography, Tabs, Tab, Box, Paper, Stack, TextField, Button, Alert, Table, TableHead, TableRow, TableCell, TableBody, Card, CardContent } from "@mui/material";
...
export default function DeanSettingsPage() {
  ...
  return (
    <Container maxWidth="lg" sx={{ py: 3 }}>
      <Typography variant="h5" sx={{ mb: 2 }}>Dean • Settings • Academics</Typography>
